...
class TestReportHandler:
    ...
    report_handler = ReportHandler(
        results_folder, gatling_folder, bucket, "eu-west-1", group
    )

    def test_content_type_from_file(self):
        assert (
            self.report_handler._content_type_from_file("some_file.js")
    ...
    def test_upload_results(self, mocker):
        ...
        boto3_mock = mocker.patch(
            "bfgg.controller.actors.report_handler.boto3"
        ).resource.return_value.Object
        logging_mock = mocker.patch("bfgg.controller.actors.report_handler.logger")

        assert (
            self.report_handler._upload_results()
        ...
        assert boto3_upload_file_call_args[0][1] == {
            "Filename": "a/b/c/ungrouped/1.html",
        ...
        assert boto3_upload_file_call_args[1][1] == {
            "Filename": f"a/b/c/ungrouped/2/2.png",
